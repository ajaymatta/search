...
app.controller('TwitterController', function($scope,$q, $http,$window, twitterService) {
	...
	$scope.chartDesign = function () {
		...
		var myLine = new Chart(document.getElementById("canvas").getContext("2d"), {type:'bar', data:data, options});
	}
